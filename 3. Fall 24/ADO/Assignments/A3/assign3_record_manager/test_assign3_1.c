...
main (void) 
{
    ...
    printf("Starting testInsertManyRecords\n");
    fflush(stdout);
	testInsertManyRecords();
    printf("Completed testInsertManyRecords\n");
    fflush(stdout);

    printf("Starting testRecords\n");
    fflush(stdout);
	testRecords();
    printf("Completed testRecords\n");
    fflush(stdout);

    printf("Starting testCreateTableAndInsert\n");
    fflush(stdout);
	testCreateTableAndInsert();
    printf("Completed testCreateTableAndInsert\n");
    fflush(stdout);

    printf("Starting testUpdateTable\n");
    fflush(stdout);
	testUpdateTable();
    printf("Completed testUpdateTable\n");
    fflush(stdout);

    printf("Starting testScans\n");
    fflush(stdout);
	testScans();
    printf("Completed testScans\n");
    fflush(stdout);

    printf("Starting testScansTwo\n");
    fflush(stdout);
	testScansTwo();
    printf("Completed testScansTwo\n");
    fflush(stdout);

    printf("Starting testMultipleScans\n");
    fflush(stdout);
	testMultipleScans();
    printf("Completed testMultipleScans\n");
    fflush(stdout);
...
void testScans (void)
{
	printf("Starting testRecords\n");
	fflush(stdout);
	fprintf(stderr, "Starting testRecords\n");
	RM_TableData *table = (RM_TableData *) malloc(sizeof(RM_TableData));
	TestRecord inserts[] = {
			{1, "aaaa", 3},
			{2, "bbbb", 2},
...
void testScansTwo (void)
{
	printf("Starting testScansTwo\n");
	fflush(stdout);
	fprintf(stderr, "Starting testScansTwo\n");
	RM_TableData *table = (RM_TableData *) malloc(sizeof(RM_TableData));
	TestRecord inserts[] = {
			{1, "aaaa", 3},
			{2, "bbbb", 2},
